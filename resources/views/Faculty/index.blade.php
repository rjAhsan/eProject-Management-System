...
<head>
  ...
  <title>eProject Managment System</title>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header" >You have <span id="notifications">4</span> messages</li>
                        <li>
...
<li>
        ...
        <li>
          <a href="{{url('schedule')}}">
            <i class="fa fa-calendar"></i> <span>Schedule Meeting</span>
            <span class="pull-right-container">
        ...
        <li>
          <a href="{{url('tasks')}}">
            <i class="fa  fa-tasks"></i> <span>Assign Tasks</span>
            <span class="pull-right-container">
        ...
        <li>
          <a href="{{url('repository')}}">
            <i class="fa fa-cloud"></i> <span>Add Repository</span>
            <span class="pull-right-container">
        ...
        <li>
          <a href="{{url('ideas')}}">
            <i class="fa fa-folder-open"></i> <span>Add New ideas</span>
            <span class="pull-right-container">
          ...
          <li>
              <a href="{{url('accept')}}">
                  <i class="fa fa-folder-open"></i> <span>Accept Project</span>
                  <span class="pull-right-container">
        ...
        <li>
          <a href="{{url('feedback')}}">
            <i class="fa fa-commenting"></i> <span>Add Feedback</span>
            <span class="pull-right-container">
