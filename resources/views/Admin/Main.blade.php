...
{{--// can  Add Website Icon to the Browser Tab i--}}

    <link rel="icon" href="{{asset('pic/logo2.jpg')}}" type="image/x-icon" />
...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="{{url('/user-Profile')}}" class="logo">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('/AdminHomeNews')}}"><i class="fa fa-circle-o"></i>ADD NEWES</a></li>

                        <li><a href="{{url('/AdminHomePostionHolder')}}"><i class="fa fa-circle-o"></i>POSTION HOLDERs</a></li>

                        <li><a href="{{url('/AdminHomeProjects')}}"><i class="fa fa-circle-o"></i>ADD PROJECTS</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/StudentReg')}}"><i class="fa fa-circle-o"></i>ADD-NEW-USER</a></li>
                        <li><a href="{{url('/List-user')}}"><i class="fa fa-circle-o"></i>REGISTERED-USER-LIST</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/AddnewGrop')}}"><i class="fa fa-circle-o"></i>REQUESTED PROJECTS LIST</a></li>

                        <li><a href="{{url('/registerproList')}}"><i class="fa fa-circle-o"></i>REGISTERED PROJECTS LIST</a></li>
                ...
                <li><a href="{{url('/Adddeadlin')}}"><i class="fa fa-circle-o"></i>DEADLINES</a></li>
                ...
                <li class="treeview">
                <li><a href="{{url('/FNotification')}}"><i class="fa fa-bell-o (alias)"></i>NOTIFICATIONS</a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>REPOSITARY</span>
                        <span class="pull-right-container">

            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('/uploadproject')}}"><i class="fa fa-circle-o"></i>UPLOAD PROJECTs </a></li>
